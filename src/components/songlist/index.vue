<template>
    <div class="songs-list-block">
        <div class="title" v-show="showhead">最新音乐</div>
        <div class="new_songs">
            <!-- https://music.163.com/m/song?id -->
            <a class="m-sgitem"  v-for="item in songlist" :href="'https://music.163.com/m/song?id=' + item.al.id ">
                <div class="itemcont">
                    <div class="item">
                        <div class="sgchfl">
                            <div class="f-thide">{{item.al.name}}
                                <span class="sgalia"></span>
                            </div>
                            <div class="sgchfr">
                                <i class="u-hmsprt"></i>
                    ...
                    <div class="playicon"><span class="sgchply"></span></div>
                </div>
            </a>
        </div>
...
export default {
    ...
    methods: {
      getlist() {
        var _this = this;
        this.http.get('cloudmusic', { type: "playlist", id: "2538096700" }).then(res => {
